...
import androidx.compose.ui.platform.getSkikoUITextInputTraits
...
import platform.UIKit.UITextStorageDirectionBackward
import platform.UIKit.UITextStorageDirectionForward
import platform.UIKit.UIView
import platform.UIKit.reloadInputViews

internal class InputServiceImpl(
    private val rootViewProvider: () -> UIView,
    private val skikoUIViewProvider: () -> UIView,
    private val keyboardEventHandler: KeyboardEventHandler,
) : PlatformTextInputService {

    val rootView get() = rootViewProvider()
    val skikoUIView get() = skikoUIViewProvider()
